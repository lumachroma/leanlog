...
- Dashboard with weight trend context, 7-day moving average, calorie average, step average, goal progress, and a Recharts dual-line weight trend chart
